...
class Home extends Component {
  ...
  componentWillMount() {
    ...
    console.log('componentWillMount this.props.auth.isAuthenticated', this.props.auth.authentication.isAuthenticated())
    window.addEventListener('scroll', this.handleHeaderClass);
  }
